                        ...
                        source.fromAsset(picture).then(imageSource => {
                            ...
                            if (picsaved) {
                                ...
                                var session = bghttp.session(
                                    "image-upload");
                                var request = {
                                    url: "https://dibsface.cognitiveservices.azure.com/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=false&returnFaceAttributes=age,gender,emotion&subscription-key=4aa538d8109a4122bb1e8351a1640ccf",
                                    method: "POST",
                                    headers: {
